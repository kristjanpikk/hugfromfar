          ...
          <div class="flex flex-col border-b border-gray-100 p-6 sm:border-0 sm:border-r">
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center">
                <svg class="w-20 text-gray-400" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 355 140">
                ...
                <svg class="w-20 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000.85 391.898">
                ...
                <svg class="w-20 text-gray-400" version="1.1" id="layer" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 652 652" xml:space="preserve">
              ...
              <div>
                ...
                <div class="relative rounded-md shadow-sm">
                  <div class="absolute inset-y-0 left-0 flex items-center">
                    ...
                    <select id="country" name="country" class="h-full py-0 pl-4 pr-8 border-transparent bg-transparent text-gray-500 focus:ring-primary focus:border-primary rounded-md">
                      <option>EE</option>
                      <option>LV</option>
                      <option>LT</option>
                    </select>
